...
export default function ProductItem({
    ...
    function addToFavorites() {
        dispatch(changeIsFav(clothes.productItem.id))
        dispatch(addToFavBox(clothes.productItem))
    }
            ...
            <section className="productItem container">
                <div className="productItem__left">
                    <Swiper
                        ...
                        className="mySwiper2">
                        <SwiperSlide>
                            {mediaMax1024 ? <img src={clothes.productItem.images[0]} />
                                : <div
                                    style={{
                                        position: "relative",
                                        height: height,
                                ...
                                >
                                    <img
                                        src={clothes.productItem.images[0]}
                                        onMouseEnter={(e) => {
                                    ...
                                    <div
                                        style={{
                                            ...
                                            backgroundImage: `url(${clothes.productItem.images[0]})`,
                        ...
                        <SwiperSlide>
                            {mediaMax1024 ? <img src={clothes.productItem.images[1]} />
                                : <div
                                    style={{
                                        position: "relative",
                                        height: height,
                                ...
                                >
                                    <img
                                        src={clothes.productItem.images[1]}
                                        onMouseEnter={(e) => {
                                            // update image size and turn-on magnifier
                                            const elem = e.currentTarget;
                                            const { width, height } = elem.getBoundingClientRect();
                                    ...
                                    <div
                                        style={{
                                            ...
                                            border: "1px solid lightgray",
                                            backgroundColor: "white",
                                            backgroundImage: `url(${clothes.productItem.images[1]})`,
                                            backgroundRepeat: "no-repeat",
                        ...
                        <SwiperSlide>
                            {mediaMax1024 ? <img src={clothes.productItem.images[2]} />
                                : <div
                                    style={{
                                        position: "relative",
                                        height: height,
                                ...
                                >
                                    <img
                                        src={clothes.productItem.images[2]}
                                        onMouseEnter={(e) => {
                                            // update image size and turn-on magnifier
                                            const elem = e.currentTarget;
                                            const { width, height } = elem.getBoundingClientRect();
                                    ...
                                    <div
                                        style={{
                                            ...
                                            border: "1px solid lightgray",
                                            backgroundColor: "white",
                                            backgroundImage: `url(${clothes.productItem.images[2]})`,
                                            backgroundRepeat: "no-repeat",
                        ...
                        <SwiperSlide>
                            {mediaMax1024 ? <img src={clothes.productItem.images[3]} />
                                : <div
                                    style={{
                                        position: "relative",
                                        height: height,
                                ...
                                >
                                    <img
                                        src={clothes.productItem.images[3]}
                                        onMouseEnter={(e) => {
                                            // update image size and turn-on magnifier
                                            const elem = e.currentTarget;
                                            const { width, height } = elem.getBoundingClientRect();
                                    ...
                                    <div
                                        style={{
                                            ...
                                            border: "1px solid lightgray",
                                            backgroundColor: "white",
                                            backgroundImage: `url(${clothes.productItem.images[3]})`,
                                            backgroundRepeat: "no-repeat",
                        ...
                        <SwiperSlide>
                            {mediaMax1024 ? <img src={clothes.productItem.images[4]} />
                                : <div
                                    style={{
                                        position: "relative",
                                        height: height,
                                ...
                                >
                                    <img
                                        src={clothes.productItem.images[4]}
                                        onMouseEnter={(e) => {
                                            // update image size and turn-on magnifier
                                            const elem = e.currentTarget;
                                            const { width, height } = elem.getBoundingClientRect();
                                    ...
                                    <div
                                        style={{
                                            ...
                                            border: "1px solid lightgray",
                                            backgroundColor: "white",
                                            backgroundImage: `url(${clothes.productItem.images[4]})`,
                                            backgroundRepeat: "no-repeat",
                    ...
                    <Swiper
                        ...
                        className="mySwiper">
                        <SwiperSlide>
                            <img src={clothes.productItem.images[0]} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src={clothes.productItem.images[1]} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src={clothes.productItem.images[2]} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src={clothes.productItem.images[3]} />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src={clothes.productItem.images[4]} />
                        </SwiperSlide>
                    </Swiper>
                </div>
                <div className="productItem__right">
                    <h1 className="product-name">{clothes.productItem.name}</h1>
                    ...
                    <div className="productItem-price">${clothes.productItem.price}</div>
                    <ul className="vestibulum">
                        <li>{clothes.productItem.category}</li>
                        <li>{clothes.productItem.brand}</li>
                        <li>{clothes.productItem.desc}</li>
                    ...
                    <div className="add-product">
                        <div className="product-count">
                            ...
                            <span>{clothes.productItem.count}</span>
